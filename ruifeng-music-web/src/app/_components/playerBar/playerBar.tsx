            ...
            <div className="tw-flex tw-flex-col md:tw-flex-row tw-items-center tw-justify-between tw-max-w-7xl tw-mx-auto tw-gap-4 md:tw-gap-0">
                ...
                <div className="tw-flex tw-items-center tw-space-x-4 tw-w-full md:tw-w-auto">
                    ...
                    <img
                        src={song.imageUrl}
                        alt={song.title}
                        className="tw-w-12 tw-h-12 md:tw-w-16 md:tw-h-16 tw-rounded-md tw-object-cover"
                    />
                    <div>
                        {/* 歌曲标题：响应式文字大小，加粗 */}
                        <h3 className="tw-text-base md:tw-text-lg tw-font-semibold">
                            {song.title}
                        </h3>
                        {/* 艺术家名：响应式文字大小，灰色 */}
                ...
                <div className="tw-flex tw-items-center tw-space-x-2 md:tw-space-x-4 tw-w-full md:tw-w-auto tw-justify-center">
                    ...
                    <button
                        ...
                        className="tw-text-lg md:tw-text-xl tw-p-1 md:tw-p-2 tw-rounded-full hover:tw-bg-gray-600"
                    >
                    ...
                    <button
                        ...
                        className="tw-text-xl md:tw-text-2xl tw-p-1 md:tw-p-2 tw-rounded-full hover:tw-bg-gray-600"
                    >
                        {isPlaying ? (
                ...
                <div className="tw-flex tw-items-center tw-space-x-2 md:tw-space-x-4 tw-w-full md:tw-w-auto tw-justify-end">
                    ...
                    <button
                        ...
                        className="tw-text-base md:tw-text-lg tw-flex tw-items-center tw-gap-1"
                    >
