...
import { TreeRepository,FindTreeOptions, FindOptionsUtils, ObjectLiteral, 
    EntityTarget, EntityManager, QueryRunner, SelectQueryBuilder,TreeRepositoryUtils } from 'typeorm';
...
import { pick, isNil, unset } from 'lodash';
